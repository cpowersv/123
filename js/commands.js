...
(function (global) {
  ...
  const THEMES = [
    ...
    { name: 'Miami Nights',    keys: ['miami nights', 'miami', 'sunset synth'],
      p: { scene: 18, hue: 0.9, saturation: 1.0, intensity: 0.8, look: 0, cutSpeed: 8, beatKick: 1.1 } },
    { name: 'Pop',             keys: ['pop theme', 'poppy', 'bubblegum pop'],
      p: { scene: 8, hue: 0.9, saturation: 1.0, intensity: 0.9, look: 4, cutSpeed: 5, beatKick: 1.2 } },
    { name: 'Surreal',         keys: ['surreal', 'surrealish', 'dreamscape', 'dali dream'],
      p: { scene: 10, hue: 0.75, saturation: 0.7, intensity: 0.7, look: 2, cutSpeed: 12, beatKick: 0.6, transDur: 2.0 } },
    ...
    { name: 'Golden Hour',     keys: ['golden hour', 'warm sunset', 'autumn'],
      p: { scene: 6, hue: 0.07, saturation: 0.9, intensity: 0.65, look: 5, cutSpeed: 11, beatKick: 0.8 } },
    { name: 'Fire & Ember',    keys: ['fire theme', 'ember', 'lava', 'inferno'],
      p: { scene: 16, hue: 0.02, saturation: 1.0, intensity: 0.95, cutSpeed: 5, beatKick: 1.4 } },
    { name: 'Vaporwave',       keys: ['vaporwave', 'aesthetic', 'retro wave'],
      p: { scene: 13, hue: 0.85, saturation: 0.8, intensity: 0.7, look: 3, cutSpeed: 9, beatKick: 0.9 } },
    ...
    { name: 'Rave',            keys: ['rave theme', 'festival theme', 'edm drop'],
      p: { scene: 11, hue: 0.78, saturation: 1.0, intensity: 1.0, cutSpeed: 3.5, beatKick: 1.6, transDur: 0.6 } },
    ...
    { name: 'Old Film',        keys: ['old film', 'vintage theme', 'silent film', 'sepia film'],
      p: { scene: 23, hue: 0.08, saturation: 0.55, intensity: 0.6, look: 2, cutSpeed: 11, beatKick: 0.7, transDur: 1.6 } },
    { name: 'Super 8',         keys: ['super 8', 'home movie', '8mm', 'retro film'],
      p: { scene: 20, hue: 0.07, saturation: 0.7, intensity: 0.6, look: 2, cutSpeed: 10, beatKick: 0.8 } },
  ];
